...
public final class DaoFabric {
	 ...
	 *
	 * @return Retourne l'instance du singleton. TP J2E Copyright © 2013-2014
	 *         Jacques Saraydaryan CPE 14
	 */
	...
	public CommentDao createCommentDao() {
		CommentDao receipesDao = new CommentDao(this.DB_HOST, this.DB_PORT,
				this.DB_NAME, this.DB_USER, this.DB_PWD);
		return receipesDao;
	}
}